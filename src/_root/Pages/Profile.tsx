...
const Profile = () => {
  ...
  return (
    <div>
      <div className="flex mt-12 md:ml-12 ml-8">
        <img
          src={user?.imageUrl}
          alt="user"
          className="lg:w-[150px] lg:h-[150px] w-16 h-16 rounded-full"
        />
        <div className="flex flex-col md:ml-8 gap-2 ml-4">
          <div className="flex items-center">
            <h1 className="font-semibold lg:text-4xl text-md">{user?.name}</h1>
             <Link to={`/update-profile/${user?.id}`}>
             <button
              onClick={handleEditProfileClick}
              className="ml-2 text-white text-xs md:text-md cursor-pointer flex gap-2 p-2 px-4 bg-[#101012] rounded-lg"
            >
              <svg
                width="24"
                height="24"
